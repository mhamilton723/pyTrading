...
from utils import load_s_and_p_data, seq2seq_split, forecast, seq2seq_dataset
...
if not load_results:
    ...
    (X_train, y_train), (X_test, y_test) = seq2seq_split(data, n_prev=100, n_masked=100)
    ...
    if not load_model:
        ...
        seq2seq = Seq2seq(input_length=maxlen, input_dim=in_out_neurons,hidden_dim=hidden_dim,
                          output_dim=in_out_neurons, output_length=maxlen, batch_size=10, depth=4)
